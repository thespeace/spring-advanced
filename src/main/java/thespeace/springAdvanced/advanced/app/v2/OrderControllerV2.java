...
public class OrderControllerV2 {
     ...
     * </ul>
     *
     * @see <a href="http://localhost:8080/advanced/v2/request?itemId=hello">정상 호출</a>
     * @see <a href="http://localhost:8080/advanced/v2/request?itemId=ex">예외 호출</a>
     */
    @GetMapping("/advanced/v2/request")
